...
if __name__ == '__main__':
    ...
    parser.add_argument('-input', help='Path to input folder (with the data.log file in it)', default='/home/ggoyal/data/vojext_exp/binary/fatigue/alice/exp1-baseline', type=str)
    parser.add_argument('-output', help='Path to output folder', default='/home/ggoyal/data/vojext_exp/yarp/fatigue/alice/exp1-baseline/tester/', type=str)
    ...
    parser.add_argument("-write_csv", type=str, default='', help="path to the cvs file for result.")
